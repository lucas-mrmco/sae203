<template>
  ...
  <div class="flex-grow w-full">
    ...
    <div
      class="flex justify-start items-start absolute overflow-hidden gap-2.5 py-[287px]"
    >
    </div>
    <div
      class="flex flex-col justify-start items-start w-full h-92 absolute left-[11.52px] top-[320.5px] overflow-hidden gap-[9px] bg-gray-50/90"
    >
      <div
